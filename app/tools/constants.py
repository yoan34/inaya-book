...
CONTEXT_GENERATE_IMG = """
Je suis en train de créer un livre pour enfant de 4 ans. Génère moi une image pour la phrase suivante: "{}". Soit simple juste pour représenter la phrase dans un style bande dessiner pour enfant. Ilusttre bien les personnes si il y en a.
"""